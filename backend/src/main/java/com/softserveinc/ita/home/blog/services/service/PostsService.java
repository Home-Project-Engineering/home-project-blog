...
public interface PostsService {
    ...
    ResponseEntity<Void> deleteComment(@ApiParam(value = "",required=true) @PathVariable("post_id") long postId
,@ApiParam(value = "",required=true) @PathVariable("id") long id
    ...
    ResponseEntity<List<Comment>> getAllComments(@ApiParam(value = "",required=true) @PathVariable("post_id") long postId
...
,@ApiParam(value = "") @Valid @RequestParam(value = "page_size", required = false) Integer pageSize
    ...
    @RequestMapping(value = "/posts",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Post>> getAllPosts(@ApiParam(value = "Find by id") @Valid @RequestParam(value = "id", required = false) long id
...
,@ApiParam(value = "") @Valid @RequestParam(value = "page_size", required = false) Integer pageSize
    ...
    @RequestMapping(value = "/posts/{post_id}/comments/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Comment> getCommentById(@ApiParam(value = "",required=true) @PathVariable("post_id") long postId
,@ApiParam(value = "",required=true) @PathVariable("id") long id
);
    ...
    @RequestMapping(value = "/posts/{post_id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Post> getPost(@ApiParam(value = "",required=true) @PathVariable("id") long id
);
